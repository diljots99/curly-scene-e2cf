...
```
npm create cloudflare@latest -- --template=cloudflare/templates/curly-scene-e2cf
```

A live public deployment of this template is available at [https://curly-scene-e2cf.templates.workers.dev](https://curly-scene-e2cf.templates.workers.dev)
